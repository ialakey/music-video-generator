...
числа ядер). Замер на демо-ролике: 702 кадра 1080p/30 с зерном, 8 ядер /
7 воркеров — 76 секунд, то есть 9.2 кадра в секунду. Трёхминутный трек по этой
цифре выходит примерно в десять минут. Что ускоряет:
